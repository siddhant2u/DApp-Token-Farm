...
openssl_md_meth_names = None # (!) real value is "frozenset({'whirlpool', 'sha3_224', 'sha512_224', 'md4', 'sha512', 'sha3_384', 'md5-sha1', 'shake_128', 'sha224', 'mdc2', 'blake2b', 'sha384', 'sha256', 'md5', 'sha512_256', 'sha1', 'sha3_512', 'shake_256', 'blake2s', 'sha3_256', 'ripemd160', 'sm3'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A9F58CE970>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A9F58CE970>, origin='C:\\\\Users\\\\Siddhant\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python38\\\\DLLs\\\\_hashlib.pyd')"
