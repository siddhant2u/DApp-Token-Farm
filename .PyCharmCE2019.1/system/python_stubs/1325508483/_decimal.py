...
class DecimalTuple(tuple):
    ...
    digits = None # (!) real value is '<_collections._tuplegetter object at 0x00000262EA24D0A0>'
    exponent = None # (!) real value is '<_collections._tuplegetter object at 0x00000262EA24D0D0>'
    sign = None # (!) real value is '<_collections._tuplegetter object at 0x00000262EA241F70>'
    _fields = (
        'sign',
        'digits',
        'exponent',
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000262EAB4E970>'

__spec__ = None # (!) real value is "ModuleSpec(name='_decimal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000262EAB4E970>, origin='C:\\\\Users\\\\Siddhant\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python38\\\\DLLs\\\\_decimal.pyd')"
