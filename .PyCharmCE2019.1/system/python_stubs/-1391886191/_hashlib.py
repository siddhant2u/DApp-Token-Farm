...
openssl_md_meth_names = None # (!) real value is "frozenset({'ripemd160', 'sha512_224', 'sm3', 'shake_128', 'whirlpool', 'sha3_256', 'blake2b', 'md5-sha1', 'sha3_512', 'shake_256', 'blake2s', 'sha224', 'md5', 'sha384', 'mdc2', 'sha512', 'sha1', 'sha512_256', 'md4', 'sha3_384', 'sha3_224', 'sha256'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002B2CB31E970>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002B2CB31E970>, origin='C:\\\\Users\\\\Siddhant\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python38\\\\DLLs\\\\_hashlib.pyd')"
