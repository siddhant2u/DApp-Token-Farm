...
openssl_md_meth_names = None # (!) real value is "frozenset({'whirlpool', 'sha512_256', 'sha3_224', 'sha224', 'blake2s', 'sha3_512', 'sha512_224', 'sha256', 'blake2b', 'sha384', 'ripemd160', 'sha3_256', 'sha512', 'md4', 'shake_128', 'shake_256', 'sha1', 'mdc2', 'md5', 'sm3', 'md5-sha1', 'sha3_384'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001FB98D9F9A0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001FB98D9F9A0>, origin='C:\\\\Users\\\\Siddhant\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python38\\\\DLLs\\\\_hashlib.pyd')"
