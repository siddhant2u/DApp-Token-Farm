# encoding: utf-8
# module _sqlite3
# from C:\Users\Siddhant\AppData\Local\Programs\Python\Python38\DLLs\_sqlite3.pyd
# by generator 1.147
# no doc
...
adapters = {
    (
        ...
        None # (!) real value is '<function register_adapters_and_converters.<locals>.adapt_date at 0x00000257453150D0>'
    ,
    (
        None, # (!) real value is "<class 'datetime.datetime'>"
        '<value is a self-reference, replaced by this string>',
    ): 
        None # (!) real value is '<function register_adapters_and_converters.<locals>.adapt_datetime at 0x00000257453153A0>'
    ,
}

converters = {
    'DATE': None, # (!) real value is '<function register_adapters_and_converters.<locals>.convert_date at 0x0000025745315160>'
    'TIMESTAMP': None, # (!) real value is '<function register_adapters_and_converters.<locals>.convert_timestamp at 0x0000025745315A60>'
}

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000025745BDF9A0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_sqlite3', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000025745BDF9A0>, origin='C:\\\\Users\\\\Siddhant\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python38\\\\DLLs\\\\_sqlite3.pyd')"
